...
`]}),e.jsx(n.p,{children:"The result? A portfolio that stands out and shows you care about craft."}),e.jsx(n.hr,{}),e.jsxs(n.p,{children:["Built with React, TypeScript, and Tailwind CSS. Source code on ",e.jsx(n.a,{href:"https://github.com/albae69",children:"GitHub"}),"."]})]})}function l(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{l as default};

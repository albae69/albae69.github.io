...
`]}),e.jsx(n.p,{children:"AI is a tool, not a replacement. The best frontend developers will be those who use AI to do more, not those who are replaced by it."}),e.jsx(n.p,{children:`The question isn't "will AI take my job?" It's "how can I use AI to do my job better?"`}),e.jsx(n.hr,{}),e.jsxs(n.p,{children:["What do you think? Is frontend development evolving or dying? Drop me an email at ahmadalbaihaqi69@gmail.com or find me on ",e.jsx(n.a,{href:"https://github.com/albae69",children:"GitHub"}),"."]})]})}function c(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{c as default};

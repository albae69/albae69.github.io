...
`]}),e.jsx(n.p,{children:"But the implementation? That's increasingly becoming AI's job."}),e.jsx(n.p,{children:`The question isn't "will AI take my job?" It's "how can I use AI to do my job better?"`}),e.jsx(n.hr,{}),e.jsxs(n.p,{children:["What do you think? I'd love to hear your experiences with AI coding tools. Drop me an email at ahmadalbaihaqi69@gmail.com or find me on ",e.jsx(n.a,{href:"https://github.com/albae69",children:"GitHub"}),"."]})]})}function t(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{t as default};
